...
>
          <div
            className="bg-white rounded-lg p-4 w-64 h-80 mb-4 mr-4 shadow-md flex flex-col items-center justify-center hover:scale-110 transition duration-300 ease-in-out hover:border-yellow-500 hover:border-b-4"
            style={{
              zIndex: 1,
              position: "absolute",
              bottom: "-30%",
          ...
          >
            <FaCar size={35} className="text-yellow-600 mb-2 " />
          ...
          >
            <FaTools size={35} className="text-yellow-600 mb-2" />
          ...
          <div
            className="bg-white rounded-lg p-4 w-64 h-80 mb-4 shadow-md flex flex-col items-center justify-center hover:scale-110 transition duration-300 ease-in-out hover:border-yellow-500 hover:border-b-4"
            style={{
              zIndex: 3,
              position: "absolute",
              bottom: "-30%",
          ...
          >
            <FaCog size={35} className="text-yellow-600 mb-2" />
            <h2 className="text-2xl font-bold mb-2 text-grey-600">Hybrid vehicles Services</h2>
            <p className="text-sm text-gray-500">
            Expert mechanics at Auto Surgeon Workshop, Karachi, specialize in hybrid vehicle services, ensuring top-notch care for your hybrid cars            </p>
          </div>
        </div>
    )
}
