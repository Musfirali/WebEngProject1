  ...
  return (
    <div className="relative min-h-screen bg-gray-100">
      ...
      <div className="relative z-10 container mx-auto p-8 ">
        <h1 className="text-3xl font-bold mt-20 mb-4 bg-yellow-600 text-white py-2 px-4 rounded-lg text-center">
          Our Services
        </h1>
        <p className="text-lg mb-8 text-center font-bold">
          At MeraMechanic, we offer a wide range of services to keep your vehicle running smoothly.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          
          <div className="p-6 m-6">
            <div className="bg-white rounded-lg shadow-lg transition duration-300 ease-in-out hover:bg-yellow-900 hover:text-white relative overflow-hidden"
              ...
              <div className="absolute bottom-0 left-0 w-full h-2 bg-yellow-500 transform translate-y-full transition-transform duration-300 ease-in-out"></div>
              <div className="flex flex-col justify-center items-center  p-4">
                <FaCogs size={35} className="text-yellow-600 m-4" />
          ...
          <div className="p-6 m-6">
            <div className="bg-white rounded-lg shadow-lg transition duration-300 ease-in-out hover:bg-yellow-900 relative overflow-hidden"
              onMouseEnter={(e) => { e.currentTarget.style.boxShadow = "0px 0px 10px 5px rgba(255, 166, 0, 1)" }}
              onMouseLeave={(e) => { e.currentTarget.style.boxShadow = "0px 0px 10px 0px rgba(0, 0, 0, 0.1)" }}>
              <div className="absolute bottom-0 left-0 w-full h-2 bg-yellow-500 transform translate-y-full transition-transform duration-300 ease-in-out"></div>
              <div className="flex flex-col justify-center items-center p-4">
                <FaBolt size={35} className="text-yellow-600 m-4" />
          ...
          <div className="p-6 m-6">
            <div className="bg-white rounded-lg shadow-lg transition duration-300 ease-in-out relative overflow-hidden hover:bg-yellow-900 hover:text-white"
              onMouseEnter={(e) => { e.currentTarget.style.boxShadow = "0px 0px 10px 5px rgba(255, 166, 0, 1)" }}
              onMouseLeave={(e) => { e.currentTarget.style.boxShadow = "0px 0px 10px 0px rgba(0, 0, 0, 0.1)" }}>
              <div className="absolute bottom-0 left-0 w-full h-2 bg-yellow-500 transform translate-y-full transition-transform duration-300 ease-in-out"></div>
              <div className="flex flex-col justify-center items-center p-4">
                <FaHeartbeat size={35} className="text-yellow-600 m-4 " />
          ...
          <div className="p-6 m-6">
            <div className="bg-white rounded-lg shadow-lg transition duration-300 ease-in-out hover:text-white hover:bg-yellow-900 relative overflow-hidden "
              onMouseEnter={(e) => { e.currentTarget.style.boxShadow = "0px 0px 10px 5px rgba(255, 166, 0, 1)" }}
              onMouseLeave={(e) => { e.currentTarget.style.boxShadow = "0px 0px 10px 0px rgba(0, 0, 0, 0.1)" }}>
              <div className="absolute bottom-0 left-0 w-full h-2 bg-yellow-500 transform translate-y-full transition-transform duration-300 ease-in-out"></div>
              <div className="flex flex-col justify-center items-center p-4">
                <FaLightbulb size={35} className="text-yellow-600 m-4" />
          ...
          <div className="p-6 m-6">
            <div className="bg-white rounded-lg shadow-lg transition duration-300 ease-in-out hover:bg-yellow-900 relative overflow-hidden"
              ...
              <div className="absolute bottom-0 left-0 w-full h-2 bg-yellow-500 transform translate-y-full transition-transform duration-300 ease-in-out"></div>
              <div className="flex flex-col justify-center items-center p-4">
                <FaPlug size={35} className="text-yellow-600 m-4" />
          ...
          <div className="p-6 m-6">
            <div className="bg-white rounded-lg shadow-lg transition duration-300 ease-in-out hover:bg-yellow-900 relative overflow-hidden"
              ...
              <div className="absolute bottom-0 left-0 w-full h-2 bg-yellow-500 transform translate-y-full transition-transform duration-300 ease-in-out"></div>
              <div className="flex flex-col justify-center items-center p-4">
                <FaBatteryHalf size={35} className="text-yellow-600 m-4" />
          ...
          <div className="p-6 m-6">
            <div className="bg-white rounded-lg shadow-lg transition duration-300 ease-in-out hover:bg-yellow-900 relative overflow-hidden"
              ...
              <div className="absolute bottom-0 left-0 w-full h-2 bg-yellow-500 transform translate-y-full transition-transform duration-300 ease-in-out"></div>
              <div className="flex flex-col justify-center items-center p-4">
                <FaFan size={35} className="text-yellow-600 m-4" />
          ...
          <div className="p-6 m-6">
            <div className="bg-white rounded-lg shadow-lg transition duration-300 ease-in-out hover:bg-yellow-900 relative overflow-hidden"
              ...
              <div className="absolute bottom-0 left-0 w-full h-2 bg-yellow-500 transform translate-y-full transition-transform duration-300 ease-in-out"></div>
              <div className="flex flex-col justify-center items-center p-4">
                <FaSignal size={35} className="text-yellow-600 m-4" />
          ...
          <div className="p-6 m-6">
            <div className="bg-white rounded-lg shadow-lg transition duration-300 ease-in-out hover:bg-yellow-900 relative overflow-hidden"
              ...
              <div className="absolute bottom-0 left-0 w-full h-2 bg-yellow-500 transform translate-y-full transition-transform duration-300 ease-in-out"></div>
              <div className="flex flex-col justify-center items-center p-4">
                <FaTools size={35} className="text-yellow-600 m-4" />
        ...
        <button
          ...
          className="w-25% mt-8 rounded-full bg-white  text-yellow-500 hover:bg-yellow-500 hover:text-white py-3 px-6 font-bold text-xl rounded transition duration-300"
