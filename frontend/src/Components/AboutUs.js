...
<div>
    <div className="flex flex-col lg:flex-row items-center justify-center py-20">
      ...
      <div className="lg:w-1/2 xl:w-2/3 pr-20">
        <h1 className="text-3xl font-bold m-8 line-yellow-500 text-center" >About Our Workshop</h1>
        <p className="text-lg font-bold text-center text-gray-400">
        Welcome to MeraMechanic, your one-stop workshop for all your car repair needs! </p>
        <h1 className="text-5xl mb-4  text-center" >Best Auto Workshop in Karachi</h1>
        <p className="text-lg   text-gray-700 ">
        Welcome to <span className=' text-yellow-500 font-bold'> MeraMechanic!</span> We are a team of expert car mechanics who specialize in electrical, electronics, Hybrid car, and mechanical repair using the latest technologies and scanners to provide our services in Karachi, Pakistan.<br/><br/>
        ...
        At <span className=' text-gray-500 font-bold'>MeraMechanic,</span> our goal is to provide our clients with an exceptional service experience that exceeds their expectations. We believe that customer satisfaction is the foundation of our success, and we’re dedicated to building long-term relationships with our clients. Our expert car mechanics are committed to providing you with the best possible service.<br/><br/>

        Thank you for considering MeraMechanic for your automotive repair needs. We look forward to serving you and providing you with the best possible service please Contact Us.
            </p>
