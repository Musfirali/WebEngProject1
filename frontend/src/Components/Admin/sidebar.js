  ...
  return (
    <div className="w-52 bg-gray-200 text-gray-800 flex flex-col items-center py-6 shadow-lg">
      ...
      <Link to="/admin/Dashboard">
        <div className="text-yellow-500 text-2xl font-bold mb-4 font-sans-serif shadow-md p-2 rounded-lg">
          MeraMechanic
        </div>
      </Link>
      ...
      <div className="flex-1 w-full flex flex-col ml-2 justify-start items-end pr-2 space-y-2">
        <Link
          to="/admin/users"
          className="flex items-center w-full p-2 text-gray-700 hover:text-white hover:bg-yellow-500 justify-start rounded-lg text-md font-bold"
        >
          ...
          {isAppointmentsDropdownOpen && (
            <div className="w-full mt-2">
              <Link
                ...
                className="block p-2 text-gray-700 hover:text-white hover:bg-yellow-500 rounded-lg"
              >
                Show Appointments
              </Link>
              <Link
