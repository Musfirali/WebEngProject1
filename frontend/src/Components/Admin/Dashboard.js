  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 p-8 bg-white">
        <div className="text-3xl font-bold p-6 text-center text-yellow-300 justify-center rounded-lg shadow-lg mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-4xl font-bold text-yellow-500">{userCount}</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h3 className="text-lg font-bold mb-2 text-gray-600">
              Total Appointments
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-4xl font-bold text-yellow-500">{orderCount}</p>
          </div>
        </div>
