    ...
    <nav className="bg-black bg-opacity-50 shadow-md p-2 fixed top-0 left-0 w-full z-50">
      <div className="container mx-auto flex items-center justify-between py-2 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center">
          ...
          <h1 className="text-yellow-500 ml-3 text-lg sm:text-2xl font-bold font-mono hidden lg:block">
            MeraMechanic
          </h1>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <div className="hidden sm:flex space-x-4">
            ...
            <a href="/car-parts" className="text-white hover:text-yellow-300">
              Car Parts
            </a>
          ...
          <a href="/cart" className="text-white hover:text-yellow-300">
            <FaCartPlus size={24} />
          </a>
      ...
      {isOpen && (
        <ul className="sm:hidden bg-black bg-opacity-90 p-4">
          <li className="mb-2">
            <a
              href="/services"
              className="text-white hover:text-yellow-300 block"
            >
              Services
            </a>
          </li>
