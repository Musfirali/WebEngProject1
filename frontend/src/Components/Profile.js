...
const Profile = ({ onProfileImageUpdate }) => {
      ...
      try {
        ...
        if (res.data) {
          const imageUrl = res.data.profileImage
            ? `http://localhost:3001${res.data.profileImage}`
            : null;
          setUser(res.data);
          setFormData({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data) {
        const imageUrl = `http://localhost:3001${res.data.profileImage}`;
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <h2 className="text-3xl font-bold mt-28 mb-4 bg-yellow-600 text-white py-2 px-4 rounded-lg text-center">
        Profile
      </h2>
      ...
      {user ? (
        <div className="flex flex-col md:flex-row items-center justify-center">
          <div className="flex flex-col items-center mb-6 md:mb-0 md:mr-6">
            ...
            <label className="bg-white text-yellow-500 hover:bg-yellow-500 hover:text-white py-2 px-4 font-bold text-xl rounded transition duration-300 border-2 border-yellow-500 cursor-pointer">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full bg-white text-yellow-500 hover:bg-yellow-500 hover:text-white py-3 px-6 font-bold text-xl rounded transition duration-300 border-2 border-yellow-500"
            >
              Update Profile
            </button>
          </form>
      ...
      <div className="flex justify-center mt-8">
        <button
          ...
          className="w-1/4 bg-white text-yellow-500 hover:bg-yellow-500 hover:text-white py-3 px-6 font-bold text-xl rounded transition duration-300 border-2 border-yellow-500"
        >
          Logout
        </button>
        <button
